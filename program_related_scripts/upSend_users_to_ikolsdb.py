    ...
    async def request(url='', formdata={}):
        ...
        async with ClientSession(connector=aiohttp.TCPConnector(verify_ssl=False)) as session:
            ...
            async with session.post(url,
                                    ...
                                    headers={"request-id":"880c46-6d64fb-879b-0de9-b1c1b84180f4",'CONNECTION': 'close','content-type': 'application/json'}) as response:
...
def push_user_to_backend_db(db=None,collection=None,config='facebook_user_ids.json'):
...
if __name__== '__main__':
    push_user_to_backend_db(db='FaceBook',collection='facebook')